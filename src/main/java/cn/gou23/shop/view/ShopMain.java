...
public class ShopMain {
	...
	protected void createContents() {
		...
		browser = new MyBrowser(tabFolder, SWT.NONE);
		browser.setUrl("http://www.alimama.com/member/login.htm?spm=a219t.7473494.1998155389.1.NqmRSF&forward=http://pub.alimama.com");
